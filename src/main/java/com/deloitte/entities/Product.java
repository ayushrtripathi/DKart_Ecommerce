...
public class Product {
	...
	public Product(String productName, String productImage, String productDescription, Integer productPrice, Integer productQty,
			Integer productDiscount, Category category) {
		super();
